...
/**
 * Срок ответа на моках отсчитывается от загрузки страницы: демо открывают когда угодно,
 * а зашитая дата к утру защиты превратилась бы в «время на ответ вышло» на всех вариантах.
 */
const expiresIn = (hours: number) => new Date(Date.now() + hours * 3_600_000).toISOString()
